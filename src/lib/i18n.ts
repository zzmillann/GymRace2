...
const DICT: Record<string, { es: string; en: string }> = {
  ...
  'set.sec.integrations': { es: 'Integraciones', en: 'Integrations' },
  'set.spotifyConnect': { es: 'Vincular Spotify', en: 'Connect Spotify' },
  'set.spotifyConnected': { es: 'Spotify conectado', en: 'Spotify connected' },
  'set.spotifyDisconnect': { es: 'Toca para desvincular', en: 'Tap to disconnect' },
