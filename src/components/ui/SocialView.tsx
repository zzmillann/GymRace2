...
export function SocialView() {
    ...
    return (
        <div className="pb-32 px-1">
            <header className="mb-8">
                <div className="flex flex-col gap-1 mb-6">
                    <div className="flex items-center justify-between">
                        <h1 className="text-4xl font-semibold tracking-tighter text-content">Social</h1>
            ...
            <AnimatePresence>
                {isLeaderboardOpen && (
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="fixed inset-0 z-[600] flex items-center justify-center p-4 bg-app/95 backdrop-blur-3xl">
                        <motion.div initial={{ scale: 0.9, y: 20 }} animate={{ scale: 1, y: 0 }} exit={{ scale: 0.9, y: 20 }} className="bg-surface border border-line/10 w-full max-w-sm rounded-[40px] p-8 relative shadow-2xl overflow-hidden max-h-[85vh] flex flex-col">
                            ...
                            <div className="flex flex-col items-center mb-10 z-10">
                                ...
                                <h2 className="text-2xl font-semibold text-content tracking-tighter">Salón de la Fama</h2>
                                <p className="text-[10px] font-medium text-muted tracking-tight mt-1">Global Top {leaderboard.length}</p>
                            </div>
                                    ...
                                    <div className="flex justify-center items-end gap-2 mb-10 mt-12 pb-4 border-b border-line/5">
                                        ...
                                        <div className="flex flex-col items-center gap-3 w-20">
                                            <div className="relative">
                                                <div className="w-16 h-16 rounded-full bg-surface-2 border-2 border-slate-400/30 overflow-hidden shadow-xl flex items-center justify-center">
                                        ...
                                        <div className="flex flex-col items-center gap-3 w-24">
                                            <div className="relative -mt-12">
                                                ...
                                                <div className="w-20 h-20 rounded-full bg-surface-2 border-4 border-amber-500 shadow-[0_0_25px_rgba(245,158,11,0.3)] overflow-hidden flex items-center justify-center">
                                        ...
                                        <div className="flex flex-col items-center gap-3 w-20">
                                            <div className="relative">
                                                <div className="w-16 h-16 rounded-full bg-surface-2 border-2 border-amber-700/30 overflow-hidden shadow-xl flex items-center justify-center">
                                    ...
                                    {leaderboard.slice(3).map((entry, idx) => (
                                        <div key={entry.id} className="bg-white/5 border border-line/5 rounded-2xl p-4 flex items-center justify-between">
                                            <div className="flex items-center gap-4">
                                                <span className="text-[10px] font-medium text-muted w-4">#{idx + 4}</span>
                                                <div className="w-10 h-10 rounded-full bg-surface-2 overflow-hidden border border-line/10 flex items-center justify-center">
                                            ...
                                            <div className="flex items-center gap-1.5">
                                                <span className="font-medium text-content">{entry.totalCompletions}</span>
                                                <Trophy24Regular className="text-amber-500" style={{ fontSize: 14 }} />
                                            </div>
                                        </div>
                                    ))}
                                </div>
                                ...
                                <div className="space-y-4">
                                    <div className="relative">
                                        ...
                                        <input 
                                            ...
                                            className="w-full bg-app border border-line/10 rounded-2xl pl-14 pr-5 py-5 text-content font-medium tracking-tight outline-none focus:border-line/20 transition-all text-center text-sm placeholder:text-muted"
                                        />
                                    </div>
                                        ...
                                        <AnimatePresence>
                                            ...
                                            {!loading && searchResults.map((u) => (
                                                <motion.div
                                                    ...
                                                    className="bg-app/40 border border-line/5 p-3 rounded-2xl flex items-center justify-between group"
                                                >
                                                    <button onClick={() => openUserDetails(u.id)} className="flex items-center gap-3 flex-1 min-w-0 text-left active:scale-[0.98] transition-transform">
                                                        <div className="w-10 h-10 rounded-full bg-surface-2 flex items-center justify-center border border-line/5 overflow-hidden flex-shrink-0">
                                            ...
                                            {!loading && searchQuery.length >= 2 && searchResults.length === 0 && (
                                                <p className="text-center text-[10px] font-medium text-muted tracking-tight py-8">No se ha encontrado a ningún guerrero</p>
                                            )}
                                        </AnimatePresence>
                                    </div>
                                </div>
                        ...
                        <motion.div key="friends-view" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="space-y-4">
                            {friends.length === 0 && (
                                <div className="text-center py-20 bg-surface/40 rounded-[40px] border border-dashed border-line/10">
                                    <p className="text-muted font-medium text-[10px] tracking-tight mb-4 text-balance px-10">Agrega a tus amigos compartiendo tu perfil</p>
                                    <button onClick={() => setActiveTab('search')} className="text-content text-xs font-medium tracking-tight border-b border-white pb-1">Ir al Buscador</button>
                                </div>
                            )}
                            {friends.map((friend) => (
                                <motion.div
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <div className="flex items-center gap-1 text-accent">
                                                ...
                                                <span className="text-[10px] font-medium">{friend.friendCount || 0} amigos</span>
                                            </div>
                                            {friend.spotifyTrack && (
                                                <button
                                                ...
                                                >
                                                    ...
                                                    <span className="text-[10px] font-medium truncate max-w-[120px]">{friend.spotifyTrack} · {friend.spotifyArtist}</span>
                                                    {sameAs(friend.spotifyTrack, friend.spotifyArtist) && <span className="text-[10px] flex-shrink-0">🎶</span>}
                                                </button>
                                            )}
                                        </div>
                                    </div>
                                    <div className="flex items-baseline gap-1 bg-app/40 px-3 py-1.5 rounded-xl border border-line/5">
                                        <Flame size={22} glow />
                                        <span className="text-xs font-medium text-content">{friend.currentStreak || 0}</span>
                                    </div>
                                </motion.div>
                            ))}
                        </motion.div>
                    ...
                    {activeTab === 'invites' && (
                        <motion.div key="invites-view" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="space-y-4">
                            {habitInvitations.length === 0 && (
                                <div className="text-center py-20 bg-surface/40 rounded-[40px] border border-dashed border-line/10 text-muted font-medium text-[10px] tracking-tight px-10">Sin desafíos pendientes</div>
                            )}
                            {habitInvitations.map((invite) => (
                                <div key={invite.id} className="bg-surface border border-line/5 rounded-[32px] p-5 flex items-center justify-between">
                                    <div className="flex items-center gap-4">
                                        <div className="w-12 h-12 rounded-full bg-surface-2 flex items-center justify-center border border-line/5 text-xl overflow-hidden shadow-xl">
                                        ...
                                        <div>
                                            <h3 className="font-medium text-content tracking-tight leading-tight">{invite.sender_name}</h3>
                                            <p className="text-[11px] font-medium text-muted tracking-tight mt-1 group-hover:text-accent transition-colors">Reto: {invite.habit_title}</p>
                                        </div>
                                    </div>
                        ...
                        <motion.div key="pending-view" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="space-y-12">
                            ...
                            <div className="space-y-6">
                                <div className="flex items-center justify-between px-2">
                                    <h3 className="text-[10px] font-medium text-muted tracking-tight">Solicitudes por Aceptar</h3>
                                    <span className="bg-accent text-content text-[11px] font-medium px-2 py-0.5 rounded-full">{pendingRequests.length}</span>
                                </div>
                                <div className="bg-surface/50 border border-line/5 rounded-[40px] overflow-hidden">
                                    {pendingRequests.length === 0 ? (
                                        <div className="py-12 text-center text-muted font-medium text-[11px] tracking-tight">No tienes peticiones nuevas</div>
                                    ) : (
                                            ...
                                            <tbody className="divide-y divide-white/5">
                                                {pendingRequests.map((req) => (
                                                    <tr key={req.id}>
                                                        <td className="p-6">
                                                            <div className="flex items-center gap-4">
                                                                <div className="w-10 h-10 rounded-full bg-surface-2 flex items-center justify-center border border-line/5 overflow-hidden">
                                                                    <Person24Regular className="text-muted" />
                                                                </div>
                                                                <div>
                                                                    <p className="font-medium text-content leading-none mb-1">{req.sender_name}</p>
                                                                    <p className="text-[11px] font-medium text-muted tracking-tight">{req.sender_code}</p>
                                                                </div>
                                                            </div>
                                                        </td>
                            ...
                            <div className="space-y-6">
                                <div className="flex items-center justify-between px-2">
                                    <h3 className="text-[10px] font-medium text-muted tracking-tight">Invitaciones un curso</h3>
                                    <span className="bg-surface-2 text-muted text-[11px] font-medium px-2 py-0.5 rounded-full">{(outgoingRequests || []).length}</span>
                                </div>
                                <div className="bg-surface/30 border border-dashed border-line/5 rounded-[40px] overflow-hidden">
                                    {(outgoingRequests || []).length === 0 ? (
                                        <div className="py-12 text-center text-muted font-medium text-[11px] tracking-tight">No has enviado ninguna invitación</div>
                                    ) : (
                                        <div className="p-2 space-y-1">
                                            {(outgoingRequests || []).map((req) => (
                                                <div key={req.id} className="bg-app/20 p-5 rounded-[32px] flex items-center justify-between group">
                                                    <div className="flex items-center gap-4">
                                                        <div className="w-10 h-10 rounded-full border border-line/5 bg-surface flex items-center justify-center overflow-hidden">
                                                            <Person24Regular className="text-muted" />
                                                        </div>
                                                        <div>
                                                            <p className="font-medium text-muted leading-none mb-1">{req.receiver_name}</p>
                                                            <p className="text-[11px] font-medium text-amber-500/80 tracking-tight animate-pulse">Pendiente de aprobación</p>
                                                        </div>
                                                    </div>
                                                    <button
            ...
            <AnimatePresence>
                {feedback && (
                    ...
                    >
                        <div className={`w-10 h-10 rounded-full flex items-center justify-center ${feedback.type === 'success' ? 'bg-white/20' : 'bg-rose-500/10'}`}>
                            {feedback.type === 'success' ? <Checkmark24Regular /> : <Warning24Regular />}
                        </div>
                        <p className="font-medium tracking-tight text-[10px] flex-1">{feedback.msg}</p>
                    </motion.div>
                )}
            </AnimatePresence>
            ...
            <AnimatePresence>
                {selectedFriend && (
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="fixed inset-0 z-[400] flex items-center justify-center p-4 bg-app/95 backdrop-blur-md">
                        <motion.div initial={{ scale: 0.9, y: 20 }} animate={{ scale: 1, y: 0 }} exit={{ scale: 0.9, y: 20 }} className="bg-surface border border-line/10 w-full max-w-sm rounded-[40px] p-8 relative shadow-2xl">
                            ...
                            <div className="grid grid-cols-2 gap-4 mb-8">
                                <div className="bg-app/40 p-5 rounded-2xl border border-line/5 flex flex-col items-center">
                                    <Fire24Regular className="text-accent mb-2" />
                                    <span className="text-2xl font-semibold text-content">{selectedFriend.totalCompletions}</span>
                                    <span className="text-[11px] font-medium text-muted tracking-tight">Éxitos</span>
                                </div>
                                <div className="bg-app/40 p-5 rounded-2xl border border-line/5 flex flex-col items-center">
                                    <span className="mb-2"><Flame size={22} glow /></span>
                                    <span className="text-2xl font-semibold text-content">{selectedFriend.maxStreak}</span>
                                    <span className="text-[11px] font-medium text-muted tracking-tight">Racha Récord</span>
                                </div>
                            </div>
                            ...
                            {selectedFriend.spotifyTrack && (() => {
                                ...
                                return (
                                    ...
                                    >
                                        <div className="w-12 h-12 rounded-full bg-[#1DB954]/20 flex items-center justify-center text-lg flex-shrink-0 overflow-hidden shadow-lg">
                                        ...
                                        <div className="min-w-0 flex-1">
                                            <div className="flex items-center gap-2 mb-0.5">
                                                <p className="text-[11px] font-medium text-[#1DB954] tracking-tight">{selectedFriend.spotifyPlaying ? 'Ahora suena' : 'Última escucha'}</p>
                                                {selectedFriend.spotifyPlaying && <Equalizer />}
                                            </div>
                                            <p className="text-content font-medium text-sm truncate">{selectedFriend.spotifyTrack}</p>
                                            <p className="text-muted text-[11px] font-medium truncate">{selectedFriend.spotifyArtist}</p>
                                            {same && (
                                                <p className="text-[#1DB954] text-[11px] font-medium tracking-tight mt-1">
            ...
            <AnimatePresence>
                {userDetails && (
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="fixed inset-0 z-[450] flex items-center justify-center p-4 bg-app/95 backdrop-blur-md">
                        <motion.div initial={{ scale: 0.9, y: 20 }} animate={{ scale: 1, y: 0 }} exit={{ scale: 0.9, y: 20 }} className="bg-surface border border-line/10 w-full max-w-sm rounded-[40px] p-8 relative shadow-2xl">
                            ...
                            {(userDetails.loading || detailsLoading) ? (
                                ...
                                <>
                                    <div className="flex flex-col items-center mb-8">
                                        <div className="w-20 h-20 rounded-3xl bg-surface-2 flex items-center justify-center text-4xl font-semibold mb-4 border border-line/5 overflow-hidden shadow-2xl">
                                        ...
                                        <h2 className="text-2xl font-semibold text-content tracking-tighter">{userDetails.name}</h2>
                                        <p className="text-[11px] font-medium text-muted tracking-tight mt-1">{userDetails.code}</p>
                                    </div>

                                    <div className="grid grid-cols-3 gap-3 mb-6">
                                        <div className="bg-app/40 p-4 rounded-2xl border border-line/5 flex flex-col items-center">
                                            <People24Regular className="text-accent mb-1" />
                                            <span className="text-xl font-semibold text-content">{userDetails.friendCount}</span>
                                            <span className="text-[10px] font-medium text-muted tracking-tight text-center">Amigos</span>
                                        </div>
                                        <div className="bg-app/40 p-4 rounded-2xl border border-line/5 flex flex-col items-center">
                                            <span className="mb-1"><Flame size={20} glow /></span>
                                            <span className="text-xl font-semibold text-content">{userDetails.maxStreak}</span>
                                            <span className="text-[10px] font-medium text-muted tracking-tight text-center">Racha Récord</span>
                                        </div>
                                        <div className="bg-app/40 p-4 rounded-2xl border border-line/5 flex flex-col items-center">
                                            <Fire24Regular className="text-amber-500 mb-1" />
                                            <span className="text-xl font-semibold text-content">{userDetails.totalCompletions}</span>
                                            <span className="text-[10px] font-medium text-muted tracking-tight text-center">Éxitos</span>
                                        </div>
                                    </div>
                                    ...
                                    <div className="bg-gradient-to-r from-amber-500/15 to-transparent border border-amber-500/20 rounded-2xl p-4 flex items-center gap-3 mb-6">
                                        ...
                                        <div>
                                            <p className="text-[11px] font-medium text-amber-500/80 tracking-tight">Top mundial</p>
                                            <p className="text-2xl font-semibold text-content">#{userDetails.rank}</p>
                                        </div>
                                    </div>

                                    {requestedIds.includes(userDetails.id) ? (
                                        <div className="w-full bg-accent/15 text-accent border border-accent/30 py-4 rounded-2xl font-medium tracking-tight text-[11px] flex items-center justify-center gap-2">
